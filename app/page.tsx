...
export default function Home() {
  ...
  const scrolltoHash = function (element_id: string) {
    ...
    // element?.scrollIntoView({ behavior: "smooth", block: "start", offset: '200', inline: "nearest" });
  ...
  return (
    ...
    <main id="top">
          ...
          <div className="h-full bg-black bg-opacity-40 px-8 lg:px-20 flex flex-col justify-center">
            ...
            <div>
              <button className="bg-[#ffd8fc] text-black rounded p-3 mt-4">
                <span onClick={() => scrolltoHash('contact-us')} className="cursor-pointer font-medium">Contact Us</span>
              </button>
      ...
      <div id="our-services" className="bg-[#ECF8F7] py-[75px] pb-10 lg:py-20 px-10 lg:px-[150px] flex flex-col">
        ...
        <div className="grid grid-cols-6 gap-4">
          <div className="col-span-6 lg:col-span-3 mb-5">
            ...
            <div className="flex flex-row gap-5 mt-3">
              <svg className="h-8 w-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd"></path></svg>
