...
export default function Home() {
  ...
  return (
    <main id="top" className="absolute top-0 w-full bg-[#f3fafb] x-lg:snap-y x-lg:snap-mandatory" style={{ scrollBehavior: 'smooth' }}>
      <Sticky />

      <div id="testimonials" className="animate-[fade-me-in_.5s_ease-in-out] text-center flex px-5 mt-[80px] md:px-20 py-5 pb-7 justify-center">
